...
public class PrincipalFrame extends JFrame {
    ...
    public PrincipalFrame(UsuarioDAO dao, ProductoDAO productoDAO) {
        this.dao = dao;
    ...
    private void cerrarSesion() {
        dispose();
        new LoginFrame(dao, productoDAO).setVisible(true);
    }

    private void volver() {
        dispose();
        new PanelPrincipalFrame(dao, productoDAO).setVisible(true);
    }
}
